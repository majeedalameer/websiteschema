...
//    @Test
    public void fetchContent() throws InterruptedException {
        ...
        map.put("URL", "http://guba.eastmoney.com/look,gssz,10523761.html");
        map.put("SITEID", "guba_eastmoney_com_100");
        map.put("CLS", "custom");
...
//    @Test
    public void fetchLinks() throws InterruptedException {
        Map<String, String> map = new HashMap<String, String>();
        map.put("URL", "http://guba.eastmoney.com/topic,000009.html");
        map.put("SITEID", "guba_eastmoney_com_100");
        map.put("JOBNAME", "guba_eastmoney_com_100");
