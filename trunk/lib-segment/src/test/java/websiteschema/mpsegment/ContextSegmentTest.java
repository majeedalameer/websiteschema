 ...
 * @author ray
 */
public class ContextSegmentTest {

    @Test
    public void should_scan_for_context_freq() {
        String str = "计算机会成本将会大大增加成功的机会，欢呼我们的机会！机会！机会！";
    ...
    @Test
    public void should_scan_for_context_freq_2() {
    ...
    @Test
    public void should_know_learning_and_studing() {
