...
public class POSArrayTest {
    ...
    public void one_Word_Could_has_Multi_POSes() {
        ...
        posArray.add(posT);
        posArray.add(posN);
        Assert.assertEquals(posArray.getOccuredCount("V"), 1);
        Assert.assertEquals(posArray.getOccuredCount("N"), 3451);
        Assert.assertEquals(posArray.getOccuredSum(), 3453);

        POSArray posArray2 = new POSArray();
        posArray2.add(posArray);
        Assert.assertEquals(posArray2.getOccuredCount("V"), 1);
        Assert.assertEquals(posArray2.getOccuredCount("N"), 3451);
        Assert.assertEquals(posArray2.getOccuredSum(), 3453);
