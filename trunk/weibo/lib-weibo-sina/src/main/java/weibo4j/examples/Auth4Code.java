...
public class Auth4Code {
	public static void main(String[] args){
		...
		postMethod.addParameter("userId", "yingrui.f@gmail.com");    //微博帐号
		postMethod.addParameter("passwd", "aaaaaasd");    //帐号密码
		try {
		...
		tokenMethod.addParameter("client_id", "2283962672");       //appkey
		tokenMethod.addParameter("client_secret", "a071a8ed4a795aba776bd8f24db3bfd3");   //appsecret
